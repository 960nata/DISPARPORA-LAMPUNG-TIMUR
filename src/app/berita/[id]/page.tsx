      ...
      <div className="container" style={{ paddingTop: "2.5rem" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "3rem" }}>
          ...
          >
            ...
            {/* Share bar */}
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: "1.5rem", display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <a href={shareWA} target="_blank" rel="noopener noreferrer" style={sBtn("#25D366")}>
              ...
              <a href={shareX} target="_blank" rel="noopener noreferrer" style={sBtn("#000")}>
              ...
              <button onClick={copyUrl} style={{ ...sBtn(copied ? "#059669" : "#64748b"), border: "none", cursor: "pointer" }}>
                {copied ? <Check size={14} /> : <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                    {recentPosts.map(r => (
                      <Link key={r.id} href={`/berita/${r.id}`} style={{ display: "flex", gap: "0.75rem", textDecoration: "none" }}>
                        <img src={r.imageUrl} alt={r.title} style={{ width: "72px", height: "56px", objectFit: "cover", borderRadius: "8px", flexShrink: 0 }} />
                        <div>
                          <p style={{ fontSize: "0.82rem", fontWeight: 700, color: "var(--text-primary)", lineHeight: 1.3, margin: "0 0 0.2rem" }}
...
function sBtn(bg: string): React.CSSProperties {
  return {
    display: "inline-flex", alignItems: "center", gap: "0.35rem",
    padding: "0.45rem 1rem", borderRadius: "8px", backgroundColor: bg,
